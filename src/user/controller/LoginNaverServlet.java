...
public class LoginNaverServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(gender + ", " + alias2);
		//User user = new User(userName, userId, userPwd, gender, userNo, alias);
		User user = new User(userName, userId+"@naver.com", userId+"@naver.com", email, phone, "m", "201900-0000000", address, alias);
