...
public class Black  implements Serializable{
	...
	public Black(int user_Code, String user_Name, String user_Id) {
		super();
	...
	public Black(int user_Code, String user_No, String user_Id, String user_Name, String email, String phone, String address,
			Date enroll_date) {
		super();
		this.user_Code = user_Code;
	...
	public Black(String user_Name, String user_Id, String user_Pwd, String gender, String user_No, String aliass) {
		super();
		this.user_Name = user_Name;
		this.user_Id = user_Id;
	...
	public Black(String user_Name, String user_Id, String user_Pwd, String email, String phone, String gender,
