...
<body>
	...
	<div class="wrapper">
		...
		<div class="inner">
			...
			<script>
				function findId(){
					window.open("http://localhost:8888/eightedu/views/loginPage/FindId.jsp", "pop1", "width=500 height=600 top=100 left=400");
				}
				function findPwd(){
					window.open("http://localhost:8888/eightedu/views/loginPage/FindPwd.jsp", "pop1", "width=500 height=600 top=100 left=400");
				}
			</script>
			...
			<div class="naverLogin">
				...
				<script type="text/javascript">
					...
					naver_id_login.setDomain("http://192.168.10.35:8888/eightedu/index.jsp"/* "http://localhost:8888/eightedu/index.jsp" */);
					naver_id_login.setState(state);
					naver_id_login.init_naver_id_login();
				</script>
			</div>

			<div class="googleLogin" style="border: 1px solid red">구글 로그인</div>
		</div>
	</div>
		<!-- FOOTER -->
