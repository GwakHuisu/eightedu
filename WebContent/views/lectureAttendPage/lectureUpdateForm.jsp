<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="lecture.model.vo.Lecture"%>
	
	<%
   	Lecture l = (Lecture)request.getAttribute("lecture");
   %>
...
<body>
   <%@ include file="../common/menuBar.jsp"%>
    <form action="<%= contextPath %>/update.le" method="post">
...
<div id="line">
	...
	<h2 align="center">강좌 수정하기</h2>
	<input type="hidden" value="<%= l.getL_code() %>" name="l_code">
        <tr>
            <th class="th" scope="row" >강좌명</th>
            <td><input type="text" class="wid80" value ="<%=l.getL_title() %>" name="title">
            </td>
        </tr>
        
          <tr>
            <th class="th" scope="row" >강의수</th>
            <td><input type="text" class="wid20" value ="<%=l.getL_number() %>" name="number">
            </td>
        </tr>
        
          <tr>
            <th class="th" scope="row" >수강료</th>
            <td><input type="text" class="wid20" value="<%=l.getL_price() %>" name="price">
            </td>
        </tr>
        ...
        <tr>
          ...
          <tr>
            ...
            <td><input type="text" class="wid40" value="<%=l.getT_name() %>" name="t_name">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <textarea name="content"><%=l.getL_content() %></textarea>
            </td>
        </tr>
  </table>
