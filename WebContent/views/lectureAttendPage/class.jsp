   ...
   <h2></h2>
      ...
      <div class="tableArea" align="right">
         <table align=center id="listArea">
            <tr id="senter">
               <th width="100">강의목차</th>
               <th width="500">강의제목</th>
               <th width="100">동영상</th>
            ...
            %>
               ...
               <tr>
               <td width="100"><%=c.getC_next() %>강</td>
               <td width="500"><%=c.getC_title() %>  [<%=c.getC_time() %>]</td>
               <td><button type="button" onclick="location.href='<%=contextPath %>/detail.vi?c_code='+<%=c.getC_code()%>">공부하기</button></td>
