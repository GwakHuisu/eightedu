...
<body>
   ...
   <form action="<%= contextPath %>/insert.pro" method="post">
  ...
  <div class="row">
	...
	<table class="question">
        <tr>
            <th class="th" scope="row" >상품명</th>
            <td><input type="text" class="wid80" placeholder="상품명을 입력해주세요" name="proName">
            </td>
        </tr>
        
          <tr>
            <th class="th" scope="row" >재고</th>
            <td><input type="text" class="wid20" placeholder="ex) 22, 23" name="remain">
            </td>
        </tr>
        
          <tr>
            <th class="th" scope="row" >가격</th>
