<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="master.Class.model.vo.*, java.util.ArrayList, lecture.model.vo.Lecture"%>
<%
...
<body>
	<%@ include file="../common/menuBar.jsp"%>
	    <form action="<%= contextPath %>/update.cl" method="post">
      ...
      <div class="row">
		...
		<input type="hidden" value="<%= c.getC_code() %>" name="c_code">
        <tr>
            <th class="th" scope="row" >강의명</th>
            <td><input type="text" class="wid80" value ="<%=c.getC_title() %>" name="c_title">
            </td>
        </tr>
 
        <tr>
            <th class="th" scope="row">강의시간</th>
            <td><input type="text" class="wid80" value ="<%=c.getC_time() %>" name="c_time">
            </td>
        </tr>
         <tr>
            <th class="th" scope="row">강의목차</th>
            <td><input type="text" class="wid80" value ="<%=c.getC_next() %>" name="c_next">
        </tr>
         <tr>
            ...
            <% } else { 
            	for(Lecture l : list) {
            %>
				<% if(c.getL_title().equals(l.getL_title())){ %>
				 <option selected value="<%=l.getL_title()%>"><%=l.getL_title()%></option>
       ...
       <tr>
         <tr>
            ...
            <td><input type="text" class="wid80" value ="<%=c.getT_name() %>" name="t_name">
        </tr>
       ...
       <div align="center">
		<hr>
						<button  type="submit" type="submit">수정하기</button>
