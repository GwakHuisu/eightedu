...
<body>
 ...
 <form action="<%=contextPath%>/insert.te" method="post">
	...
	<table class="question">
		<tr>
            <th class="th" scope="row" >강사이름</th>
            <td><input type="text" class="wid30" placeholder="강사명을 입력해주세요" name="t_name"/>
            </td>
        </tr>
 
        <tr>
            <th class="th" scope="row">연락처</th>
            <td><input type="text" class="wid30"  placeholder="ex) 010-1234-5678" name="t_phone"></td>
        </tr>
        <tr>
           <th class="th" scope="row">주소</th>
           <td><input type="text" class="wid96"  placeholder="ex) 서울시 강동구 강일동" name="t_address"></td>
        </tr>
  </table>
