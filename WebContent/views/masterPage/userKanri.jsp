...
<body>
	...
	<div class="cus">
		...
		<table class="menu" align="center">
			<tr>
				<td width="250" height="250">신고 목록 확인
					<div id="menu1">
						<a href="<%=contextPath%>/list.re">
							<img id="menu1" src="../../resources/file/image/listblack.png"
							width="200" height="200">
						</a>
					</div>
				</td>
				<td width="250" height="250">블랙리스트 확인
					<div id="menu2">
						<a href="<%=contextPath%>/list.be"><!-- /views/masterPage/con_user.jsp -->
							<img id="menu2" src="../../resources/file/image/blacklist.png"
