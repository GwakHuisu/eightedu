...
<body>
	...
	<div class="cus">
		...
		<table class="menu" align="center">
			<tr>
				<td width="250" height="250">사용자 관리
					<div id="menu1">
						<a href="<%=contextPath%>/views/masterPage/con_userteacher.jsp">
							<img id="menu1" src="../../resources/file/image/user.png"
							width="200" height="200">
						</a>
					</div>
				</td>
				<td width="250" height="250">강의 관리
					<div id="menu2">
						<a href="<%=contextPath%>/list.cl">
							<img id="menu2" src="../../resources/file/image/video.png"
							width="220" height="220">
						</a>
					</div>
				</td>
				<td width="250" height="250">동영상 관리
					<div id="menu2">
						<a href="<%=contextPath%>/list.video">
							<img id="menu2" src="../../resources/file/image/video.png"
							width="220" height="220">
						</a>
					</div>
				</td>
				<td width="250" height="250">포인트 샵 관리
					<div id="menu3">
						<a href="<%=contextPath%>/ShopList.ma">
							<img id="menu3" src="../../resources/file/image/Shop.png"
							width="200" height="200">
						</a>
					</div>
				</td>
