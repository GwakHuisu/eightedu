...
<body>
	...
	<div class="cus">
		...
		<table class="menu" align="center">
			<tr>
				<td width="250" height="250">신규 강사 등록
					<div id="menu1">
						<a href="<%=contextPath%>/views/masterPage/teacher_plus.jsp">
							<img id="menu1" src="../../resources/file/image/teacher_plus.png"
							width="200" height="200">
						</a>
					</div>
				</td>
				<td width="250" height="250">기존 강사 목록
					<div id="menu2">
						<a href="<%=contextPath%>/list.te"><!-- /views/masterPage/con_user.jsp -->
							<img id="menu2" src="../../resources/file/image/teacher_list.png"
