<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="master.Video.model.vo.Video"%>
<%
...
<body>
	...
	<table class="question">
        ...
        <tr>
         ...
         <tr>
            <th class="th" scope="row">영상주소</th>
            <td><%=v.getV_link() %></td>
        </tr>
        <tr>
            <th class="th" scope="row">영상길이</th>
            <td><%=v.getC_time() %></td>
        </tr>
       ...
       <div align="center">
		<hr>
			...
			<form action="" id="detailForm" method="post">
				<input type="hidden" name="b_code" value="<%=v.getV_code()%>">
			</form>

		<script>
        function UpdateClass(){
        	location.href = "<%=contextPath%>/updateForm.video?v_code="+<%=v.getV_code()%>;
        ...
        function DeleteClass(){
			...
			location.href="<%= contextPath %>/delete.video?v_code="+<%=v.getV_code()%>;
