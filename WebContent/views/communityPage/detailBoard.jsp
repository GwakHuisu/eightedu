		...
		<div class="row">
			...
			<div id="line">
				...
				<div align="center" id="btnButton">
					...
					<% if(loginUser != null && !loginUser.getAliass().equals("마스터")) { %>	
					<button type="button"
					...
					<%} else if(loginUser != null && loginUser.getAliass().equals("마스터")) { %>	
					<!-- 신고하기 버튼 추가!!! -->
					<button type="button"
					...
					<!-- 로그인한 회원이 글쓴이인 경우 -->
					<%
						if (loginUser != null && aliass.equals(loginUser.getAliass()) && !loginUser.getAliass().equals("마스터")) {
					%>
