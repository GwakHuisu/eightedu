...
<%
	...
	String updateCategory = board.getM_name();
				...
				<div id="line">
					...
					<div id="board-title">
						<input type="text" class="input-title" id="subject"
							name="update_title" placeholder="제목을 입력하세요." style="width: 97%"
							, value="<%=board.getB_title()%>">
					</div>

					<div id="board-content">
						<textarea id="summernote" name="update_content"><%=board.getB_content()%></textarea>
					</div>
					<script>
                  ...
                  <div>
                     ...
                     <script>
                        function optionChange() {
                           var board = [ "——", "잡담", "질문","정보", "공부팁", "시험후기" ];
                           var boardVal = ["——", "101", "102", "103", "104", "105"];
                           ...
                           if (selectOption == "영어" || selectOption == "일본어" || selectOption == "중국어") {
                              changeOption = board;
                              optionVal = boardVal;
